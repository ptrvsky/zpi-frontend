    ...
    render() {
        return (
            <div className="menu-element-wrapper">
                ...
                <div className="ingridients-element">{this.props.details.pizzas[0] ? this.props.details.pizzas.map((pizzaIngredient, index) =>
                    pizzaIngredient.name + (index < this.props.details.pizzas.length - 1 ? ', ' : '')
                ) : null}</div>
